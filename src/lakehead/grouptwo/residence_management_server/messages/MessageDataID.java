...
// these are the different data options that the client can request from the server
...
public enum MessageDataID {
							...
							NUMBER_OF_APPLICATIONS, ALL_BUILDINGS, NAME_OF_BUILDING, CAPACITY_OF_ROOM,
							DEVICES_IN_ROOM
						};